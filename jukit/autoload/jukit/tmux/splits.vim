...
fun! jukit#tmux#splits#output(...) abort
    ...
    let g:jukit_output_title = matchstr(response, '[a-zA-Z]\+:[0-9]*\.[0-9]\+')
    echom g:jukit_output_title
    " let g:jukit_output_title = response
    " call jukit#tmux#cmd#tmux_command('last-pane')
    " call system('tmux last-pane')
    call system('tmux resize-window -R 2000')
    "
...
fun! jukit#tmux#splits#term(...) abort
    ...
    call system('tmux resize-window -R 200')
...
fun! jukit#tmux#splits#history() abort
    ...
    call jukit#tmux#cmd#tmux_command('last-pane')
    " let t1 = call system('tmux last-pane')
